    ...
    >
      <div className="content-box">
        ...
        <div className="management-section">
          <h3>LOTTE Chemical Pakistan Ltd. Extends Support to Flood Victims of Mirpurkhas Region</h3>
          
          <p className="body-text">
            <strong>Karachi:</strong> LOTTE Chemical Pakistan (LOTTE Chemical Pakistan), a subsidiary of one of South Korea's largest conglomerates operating in Pakistan, after it's endeavours to help flood victims in the Badin District continued its unswerving efforts to help those suffering from the recent floods in Mirpurkhas and adjoining areas.
          </p>
        ...
        <div className="management-section">
          <h3>LOTTE Reaches Out to Flood Victims at Badin District</h3>
