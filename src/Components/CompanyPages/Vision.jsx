    ...
    >
      <div className="content-box">
        ...
        <div className="value-section">
          <h3>Values</h3>
          <p className="body-text" style={{color: "blue"}}>
            Core Values are the standard that all the LOTTE staff should aspire towards so that LOTTE can fulfill its mission and vision.
          </p>
        </div>
        ...
        <div className="core-values">
          ...
          <p>We quickly respond to changes, cooperate with other fields without boundaries, and implement innovations to develop originality inimitable by anyone</p>
        </div>
      </div>
    </PageLayout>
  )
